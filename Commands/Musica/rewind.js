...
module.exports = {
    ...
    .setName('retroceder')
    .setDescription('retrocede segundos una cancion')
    .addIntegerOption(option => 
        option.setName('tiempo')
        .setDescription('El tiempo que retrocederas la cancion (10 = 10s)')
        .setMinValue(0)
        .setRequired(true)
        ),
        async execute(interaction) {
            ...
            try {
                ...
                await queue.seek(queue.currentTime - seconds);
                            embed.setColor("Blue").setDescription(`⏮ se atrasaron \`${seconds}s\``)
